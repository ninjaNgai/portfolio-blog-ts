...
<div style={{ color: 'darkblue' }}>Enhancing Self-Awareness.</div>
<div style={{ textAlign: 'center', color: 'darkblue' }}>Innovation through Collaboration.</div>
<div style={{ textAlign: 'right', color: 'darkblue' }}>Enhancing Self-Awareness.</div>
...
<div>
  ...
  <span>
    We started off the day with a financial advice conversation with Shannaan Dawda and Mike Todasco
