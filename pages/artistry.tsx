            ...
            <Stack spacing={4}>
              <Box mb={{ base: 8, md: 20 }}>
                ...
                <Text fontSize={'lg'} color={'gray.500'}>
                  &quot;Many of my creative projects explore producing movement in the present
                  moment by drawing from my diverse background of various movement styles and
                  technological experience.&quot;
                </Text>
                <br></br>
                <Text fontSize={'xl'} color={'black.500'}>
                  Courtney Ngai is an improvisational artist, choreographer, and software engineer.
                  She explores producing movement in the present moment by drawing from her diverse
                  background of various movement styles and technological experience. Bringing a
                  background of twenty-one years of dance experience, she has trained in the styles
                  of contemporary, ballet, tap, urban movement, hip hop, jazz, and latin.
                </Text>
                <br></br>
                <Text fontSize={'xl'} color={'black.500'}>
                  Courtney has presented and performed various collaborative works in many
                  performances including Irene Ashu’s Hope for the World Benefit Show, Barrett
                  Honors Talent Showcases, ASU Dance Undergraduate Shows, and Peter Chu’s Red, White
                  & Chu Festival. She is a Phoenix native and holds a degree in Computer Science and
                  Dance Minor from Barrett, The Honors College at Arizona State University. She is
                  also an alumni of CONDER|dance. The topic of her Honors thesis was on the
                  integration of web application development and dance improvisation. She aspires to
                  combine dance and technology to create a mental footprint that will push the
                  boundaries of how movement and the digital space interact and influence each
                  other.
                </Text>
              </Box>
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
