...
const Profile = ({ posts }) => {
  ...
  const danceYears = new Date().getFullYear() - 2001;
      ...
      <Container maxW={'3xl'}>
        <VStack textAlign={'left'} spacing={{ base: 8, md: 14 }} py={{ base: 10, md: 20 }}>
          ...
          <Text color={'black.500'}>
            ...
            I’ve also been a dancer for {danceYears}+ years which cultivates a practice of
            discipline, grit, and artistry/creativity. Integrating my knowledge of Software
            Engineering & Dance, I can creatively produce real-world solutions and leverage
            technology to provide value to users.
            <br />
            <br />
